...
public class Overworld extends javax.swing.JFrame implements KeyListener {
    ...
    private void initComponents() {
        ...
        pbHealth.setBackground(new java.awt.Color(0, 0, 0));
        pbHealth.setForeground(new java.awt.Color(153, 0, 0));
        pbHealth.setFocusCycleRoot(true);
        getContentPane().add(pbHealth);
        pbHealth.setBounds(200, 60, 250, 30);
        getContentPane().add(pbExp);
        pbExp.setBounds(200, 144, 250, 30);
